import { getQaLogsList } from '@/features/root/qa-logs/repositories'
import { selectManageQaLogSchema } from '@/features/root/qa-logs/schema'
...
const paginatedResponseSchema = z.object({
  data: selectManageQaLogSchema.array(),
  meta: z.object({
    page: z.number(),
    limit: z.number(),
    total: z.number(),

...
// languageId           | integer | required | references languages.id
//
// ============================================================================
...
export const selectManageQaLogSchema = createSelectSchema(qaLogs).extend({
...
export type SelectManageQaLog = z.infer<typeof selectManageQaLogSchema>

export const insertQaLogSchema = createInsertSchema(qaLogs)
export const selectQaLogSchema = createSelectSchema(qaLogs)
